...
function Properties() {
  ...
  return (
    <div className="min-h-screen bg-page">
        ...
        <div className="container py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button
                className={`p-2 rounded-md ${showFilters ? 'bg-primary-100 text-primary-600' : 'hover:bg-surface-muted'}`}
      ...
      {/* Filters */}
      {showFilters && (
        <div className="bg-surface shadow-md border-t border-line">
          <div className="container py-6">
            ...
            >
              <Link to={`/properties/${property.id}`}>
                ...
                <div className="p-6">
                  ...
                  {/* Token Details */}
                  <div className="bg-page rounded-lg p-3 mb-4">
                    <div className="flex justify-between text-sm">
