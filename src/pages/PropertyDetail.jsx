      ...
      <div className="bg-surface shadow">
        <div className="container py-4">
          <div className="flex items-center space-x-2 text-sm">
            <Link to="/" className="text-muted hover:text-primary-600">Home</Link>
            <span className="text-secondary-400">/</span>
            <Link to="/properties" className="text-muted hover:text-primary-600">Properties</Link>
            <span className="text-secondary-400">/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="bg-page rounded-lg p-6 mb-6">
          ...
          >
            ...
            <div className="card p-6">
              ...
              <div className="flex items-center justify-center space-x-4 pt-4 border-t border-line">
